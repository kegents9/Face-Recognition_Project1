...
encodeElon = face_recognition.face_encodings(imgmain_resize)[0]
...
encodeTest = face_recognition.face_encodings(imgTest_resize)[0]
...
cv2.imshow('Main Image', imgmain_resize)
